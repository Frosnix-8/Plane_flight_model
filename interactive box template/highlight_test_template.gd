...
#Highlight and Highlighter are instances specific to this object.
...
##NOTE: if you change this, it is best recomended turning the Outliner shader into an instance 
##for continuity, otherwise the highlighting effect and the outline will not be congruent. 
